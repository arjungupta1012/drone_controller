...
############################################################################################################################################
    ...
    #     while(self.vehicle.location.global_relative_frame.alt < target_altitude*0.90):
    #         print(f'Elevating, Current Altitude: {self.vehicle.location.global_relative_frame.alt}')
    #         time.sleep(0.5)
